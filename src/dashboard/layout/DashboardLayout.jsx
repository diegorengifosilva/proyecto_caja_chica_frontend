...
const SIDEBAR_ITEMS = [
    ...
    items: [
      {
        ...
        roles: ["Administrador", "Jefe de Proyecto", "Colaborador"],
      },
    ],
  },
  {
    ...
    items: [
      {
        to: "/dashboard/liquidaciones/solicitud",
        label: "Solicitud de Gasto",
        icon: FilePlus,
        roles: ["Administrador", "Jefe de Proyecto", "Colaborador"],
      },
      {
        to: "/dashboard/atencion-solicitudes",
        label: "Atención de Solicitudes",
        icon: ListChecks,
        roles: ["Administrador", "Jefe de Proyecto"],
      },
      {
        to: "/dashboard/liquidaciones/presentar",
        label: "Liquidaciones",
        icon: FolderKanban,
        roles: ["Administrador", "Jefe de Proyecto", "Colaborador"],
      },
      {
        to: "/dashboard/gastos/aprobacion-liquidacion",
  ...
  },
  {
    ...
    items: [
      {
        to: "/dashboard/movimientos/arqueo",
        label: "Caja Chica",
        icon: Wallet,
        roles: ["Administrador"],
      },
      {
        to: "/dashboard/registros/actividades",
        label: "Registro de Actividades",
        icon: ClipboardList,
        roles: ["Administrador", "Jefe de Proyecto", "Colaborador"],
      },
      {
        to: "/dashboard/registros/guias-salida",
...
export default function DashboardLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-[#f3f4f6]">
      {/* Sidebar */}
      <aside
        className={`fixed md:static z-40 top-0 left-0 h-screen bg-white shadow-md border-r flex flex-col transform transition-all duration-300
      ...
      >
        ...
        <div className="flex-1 flex flex-col overflow-y-auto">
          ...
          <div className="flex flex-col items-center justify-center py-6 border-b relative group">
            ...
            {/* Botón de colapsar visible en hover */}
            <button
